        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadOriginId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientProperties_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientServiceHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientServiceHistories_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientServiceHistories_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientProperties_PropertyId",
                table: "ClientProperties",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientServiceHistories_ClientId",
                table: "ClientServiceHistories",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientServiceHistories_UserId",
                table: "ClientServiceHistories",
                column: "UserId");
